namespace CrossChat.Integrations.Interfaces
{
	public interface IFaceBookService
	{
		...
		// Media part
		Task<(bool Success, string? PostId)> PublishToPageAsync(string message, string acessToken, string pageIdToPublish, List<string> base64Images = null, string locationId = null);
